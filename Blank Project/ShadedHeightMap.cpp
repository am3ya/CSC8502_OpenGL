#include "ShadedHeightMap.h"
#include "../nclgl/Camera.h"

ShadedHeightMap::ShadedHeightMap(Shader* shader, GLuint tex, Mesh* mesh, GLuint sandBump, GLuint grassTex, GLuint grassBump, GLuint rockTex, GLuint rockBump) : ShadedSceneNode(shader, mesh, tex) {
...
void ShadedHeightMap::Draw(const OGLRenderer& r) {
	LoadTexture();
